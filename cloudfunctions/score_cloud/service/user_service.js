...
// 用户信息返回字段
const FILEDS_USER_BASE = 'USER_ADD_TIME,USER_VIEW_CNT,USER_EDU,USER_INFO_CNT,USER_ALBUM_CNT,USER_NAME,USER_BIRTH,USER_SEX,USER_PIC,USER_STATUS,USER_CITY,USER_COMPANY,USER_TRADE,USER_COMPANY_DUTY,USER_LOGIN_TIME,USER_MINI_OPENID';
...
class UserService extends BaseCCMiniService {
	...
	async getMyDetail(userId,
		fields = 'USER_SEX,USER_ALBUM_CNT,USER_INFO_CNT,USER_VIEW_CNT,USER_NAME,USER_PIC,USER_STATUS,USER_ID'
	) { 
